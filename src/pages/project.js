    ...
    return(
        <div>
            ...
            <div class="post-list">
                <ul>
                    <li>
                        <a id="blog-title" href="">Color Game made using DOM Manipulation and JQuery</a>
                        <h4>
                    ...
                    <li>
                        <a id="blog-title" href="">Airline Reservation System</a>
                        <h4>
