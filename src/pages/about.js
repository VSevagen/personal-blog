    ...
    return (
        <div class="about">
            ...
            <div class="layout">
                ...
                <p>
                    <span class="alignment">- The GNOME Project</span><br></br>
                    <span class="center-tag">Things I've meddled with</span><span>   - Web Development</span>  <br></br>
                    <span class="alignment">- Deep Learning (<strong>Recently started</strong>)</span>              
                </p>
                <p class="text-center">--------------------------------------||---------------------------------------</p>
