...
import mediawiki2 from "./images/mediawiki2.png"
import mediawiki3 from "./images/mediawiki3.png"
    ...
    return(
        <div>
            ...
            <div class="post-list">
                <ul>
                    <li>
                        <div class="blog-title">Part 1: How to install MediaWiki</div>
                        <div class="blog-date">June 22, 2019</div>
