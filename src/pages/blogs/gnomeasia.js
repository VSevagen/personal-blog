        ...
        <div>
              <Header />
                <div class="post-list">
                    <ul>
                        <li>
                            <div class="blog-title">GNOME Asia 2019</div>
                            <div class="blog-date">Oct 15, 2019</div>
...
<img class="blog_img" src={Gnomeasia}></img><br></br><br></br>
...
<img class="blog_img" src={WorkShop}></img><br></br><br></br>
...
<img class="blog_img" src={Dance}></img><br></br><br></br>
...
<img class="blog_img" src={Group}></img><br></br><br></br>
...
<img id="unique" class="blog_img" src={Director}></img><br></br><br></br>
...
<img class="blog_img" src={FishCurry}></img><br></br><br></br>
...
<img class="blog_img" src={Boarding}></img><br></br><br></br>
The next morning, I took a plane back to India, waving goodbye to Indonesia 😉<br></br><br></br>
<img id="unique" class="blog_img" src={Sponsor}></img>
                                </p>
                            </div>
                        </li>
                    </ul>
